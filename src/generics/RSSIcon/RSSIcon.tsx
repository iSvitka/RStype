...
export function RSSIcon() {
    return (
        <svg className={styles.RSSIcon} id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 552.8 205.3">
            ...
            <ellipse transform="rotate(-37.001 420.46 67.88)" className={styles.st0} cx="420.5" cy="67.9" rx="63" ry="51.8" />
            <defs>
            ...
            <g className={styles.st1}>
                <path transform="rotate(-37.001 420.82 68.353)" className={styles.st0} d="M330.9-14.2h179.8v165.1H330.9z" />
                <g id="Layer_2_1_">
                    <defs>
                    ...
                    <g id="Layer_1-2" className={styles.st2}>
                        <ellipse transform="rotate(-37.001 420.46 67.88)" className={styles.st0} cx="420.5" cy="67.9" rx="63" ry="51.8" />
                        <defs>
                        ...
                        <g className={styles.st3}>
                            <path transform="rotate(-37 420.799 68.802)" className={styles.st0} d="M357.8 17h125.9v103.7H357.8z" />
                            <defs>
                            ...
                            <g className={styles.st4}>
                                <ellipse transform="rotate(-37.001 420.46 67.88)" className={styles.st5} cx="420.5" cy="67.9" rx="63" ry="51.8" />
                            </g>
                            <path transform="rotate(-37 420.799 68.802)" className={styles.st6} d="M357.8 17h125.9v103.7H357.8z" />
                            <ellipse transform="rotate(-37.001 420.46 67.88)" className={styles.st7} cx="420.5" cy="67.9" rx="63" ry="51.8" />
                            <path transform="rotate(-37 420.799 68.802)" className={styles.st0} d="M357.8 17h125.9v103.7H357.8z" />
                            <defs>
                            ...
                            <path transform="rotate(-37 420.799 68.802)" className={styles.st9} d="M357.8 17h125.9v103.7H357.8z" />
                            <path transform="rotate(-37.001 420.82 68.353)" className={styles.st7} d="M330.9-14.2h179.8v165.1H330.9z" />
                        </g>
                        <ellipse transform="rotate(-37.001 420.46 67.88)" className={styles.st7} cx="420.5" cy="67.9" rx="63" ry="51.8" />
